...
const items = [
  {
    name: "twitter",
    url: "https://twitter.com/sarvesh4396",
  ...
  {
    name: "linkedin-in",
    url: "https://linkedin.com/in/sarvesh4396",
  ...
  {
    name: "github",
    url: "https://github.com/sarvesh4396/",
...
function Footer() {
  return (
    <footer className="text-center bottom-0 left-0 w-screen">
